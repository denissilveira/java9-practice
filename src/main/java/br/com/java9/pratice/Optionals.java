...
public class Optionals {
    ...
    public static void main(String[] args) {
        ...
        final Book book = new Book("Desbravando Java", "Rodrigo Turini", Category.PROGRAMMING);
        ...
        // ifPresentOrElse
        Books.findSimilar(book)
            .ifPresentOrElse(System.out::println, () -> System.out.println("Não existem similares"));

        
        List<Book> books = List.of(
                new Book("Desbravando Java", "Rodrigo Turini", Category.PROGRAMMING),
                new Book("Java 8 Prático", "Paulo Silveira", Category.PROGRAMMING),
        ...
        // encadeando ORs
        Books.findSimilar(book)
            .or(() -> Books.findSimilar(book)) // seria para buscar por um book2
            .or(() -> Books.findSimilar(book)); // seria para buscar por um book3
    }
}